...
namespace UnityStandardAssets.Characters.ThirdPerson
{
	public class ThirdPersonCharacter : MonoBehaviour
	{
		...
		void UpdateAnimator(Vector3 move)
		{
			...
			// calculate which leg is behind, so as to leave that leg trailing in the jump animation (This code is reliant on the specific run cycle offset in our animations, and assumes one leg passes the other at the normalized clip times of 0.0 and 0.5).
			...
			// The anim speed multiplier allows the overall speed of walking/running to be tweaked in the inspector, which affects the movement speed because of the root motion.
